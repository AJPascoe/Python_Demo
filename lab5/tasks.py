...
def grade():
    ...
    w = f"Min: {min(grades)}, Max: {max(grades)}, Average: {av}, Mean: {round(mean)}, Median: {med}"
    print(f"The grade list is: {grades}")
    print(f"The lowest grade is {min(grades)}")
    print(f"The highest grade is {max(grades)}")
    print(f"The average grade is {av}")
    print(f"The mean sum for grades is {round(mean)}")
    print(f"The median sum for grades is {med}")
    print(w)
grade()